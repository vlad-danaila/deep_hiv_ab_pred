from deep_hiv_ab_pred.util.tools import create_folder, download_file
from deep_hiv_ab_pred.catnap.constants import *
...
def download_catnap():
    ...
    download_file(ANTIBODIES_HEAVY_DOWNLOAD, ANTIBODIES_HEAVY_FASTA_FILE)
    download_file(ANTIBODIES_LIGHT_DOWNLOAD, ANTIBODIES_LIGHT_FASTA_FILE)
