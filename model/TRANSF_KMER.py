...
class TRANSF_KMER(t.nn.Module):
    ...
    def __init__(self, conf, src_seq_len, tgt_seq_len, embeddings_matrix = None):
        ...
        self.fully_connected = t.nn.Linear(self.transf_d_model * tgt_seq_len, 1)
...
def get_TRANSF_KMER_model(conf, src_seq_len, tgt_seq_len):
    model = TRANSF_KMER(conf, src_seq_len, tgt_seq_len, get_embeding_matrix()).to(device)
